(function () {
  ...
  var getProductInformation = exports.getProductInformation = function (obj, callback)
  {
    var productHtml = getProductPageHtml(obj.productId, function onResponse(error, response, body)
    {
      var productPageHtml = body;
      if(isValidProductPage(productPageHtml))
      {
        var percentageSaving = 0;
        var productInfoJson = getProductInformationFromProductPage(productPageHtml);
